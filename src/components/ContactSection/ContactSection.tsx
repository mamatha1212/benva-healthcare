        ...
        <div className={styles.layout}>
          ...
          <div className={styles.infoCol}>
            ...
            <div className={styles.quickActions}>
              <button className={`${styles.actionBtn} ${styles.actionCall}`}>📞 Call Now</button>
              <button className={`${styles.actionBtn} ${styles.actionWa}`}>💬 WhatsApp Now</button>
              <button className={`${styles.actionBtn} ${styles.actionEmail}`}>📧 Email Us</button>
            </div>
