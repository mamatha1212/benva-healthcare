  ...
  return (
    <section className={styles.heroSection}>
      ...
      <div className={styles.bgElements}>
        ...
        <svg className={styles.ekgLineBg} preserveAspectRatio="none" viewBox="0 0 1000 200"><path d="M250,100 L450,100 L470,50 L500,180 L530,20 L560,130 L580,100 L1000,100" fill="none" stroke="rgba(255, 255, 255, 0.05)" strokeWidth="1.5" /><path className={styles.ekgPulseBg} d="M250,100 L450,100 L470,50 L500,180 L530,20 L560,130 L580,100 L1000,100" fill="none" stroke="rgba(255, 255, 255, 0.15)" strokeWidth="1" /></svg>
      </div>
