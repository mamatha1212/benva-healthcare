      ...
      <div className={styles.container}>
        ...
        <div className={styles.rightColumn}>
          <div className={styles.circleContainer}>
            {/* EKG Line behind circle */}
            <svg className={styles.ekgLine} preserveAspectRatio="none" viewBox="0 0 1000 200">
              <path d="M0,100 L250,100 L270,50 L300,180 L330,20 L360,130 L380,100 L1000,100" fill="none" stroke="rgba(255, 255, 255, 0.05)" strokeWidth="1.5" />
              <path className={styles.ekgPulse} d="M0,100 L250,100 L270,50 L300,180 L330,20 L360,130 L380,100 L1000,100" fill="none" stroke="rgba(255, 255, 255, 0.3)" strokeWidth="1.5" />
            </svg>
