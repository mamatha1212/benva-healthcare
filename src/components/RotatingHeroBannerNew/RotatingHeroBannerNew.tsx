...
import styles from './RotatingHeroBannerNew.module.css';
...
export default function RotatingHeroBannerNew() {
    ...
    <section className={styles.heroSection}>
      ...
      <div className={styles.circleContainer}>
        ...
        <div className={styles.rotatingTrack}>
          {ITEMS.map((item, index) => {
            ...
            // Delay scale pulse so each item highlights exactly when reaching the bottom (90deg)
            ...
            return (
              ...
              >
                {/* 
                  First inner wrapper counter-rotates the initial placement angle.
                */}
                <div 
                  style={{ 
                    width: '100%', 
                ...
                >
                  {/* 
                    Second inner wrapper counter-rotates the continuous track movement.
                  */}
                  <div style={{
                    width: '100%', 
                    height: '100%',
      ...
      <div className={styles.bottomContent}>
        ...
        <div className={styles.textContent}>
          <h2 className={styles.mainHeading}>Quality Healthcare at Your Fingertips</h2>
